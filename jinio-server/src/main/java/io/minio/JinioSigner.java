...
public class JinioSigner {
     ...
     *
     */
    public JinioSigner(Request request, String contentSha256, DateTime date, String region, String accessKey,
    ...
    public static String getChunkSignature(String chunkSha256, DateTime date, String region, String secretKey,
        ...
        JinioSigner jinioSigner = new JinioSigner(null, chunkSha256, date, region, null, secretKey, prevSignature);
        jinioSigner.setScope();
        jinioSigner.setChunkStringToSign();
        jinioSigner.setSigningKey();
        jinioSigner.setSignature();

        return jinioSigner.signature;
    }
    ...
    public static String getChunkSeedSignature(Request request, String region, String secretKey)
        ...
        JinioSigner jinioSigner = new JinioSigner(request, contentSha256, date, region, null, secretKey, null);
        jinioSigner.setScope();
        jinioSigner.setCanonicalRequest();
        jinioSigner.setStringToSign();
        jinioSigner.setSigningKey();
        jinioSigner.setSignature();
    ...
    public static Request signV4(Request request, String region, String accessKey, String secretKey)
        ...
        JinioSigner jinioSigner = new JinioSigner(request, contentSha256, date, region, accessKey, secretKey, null);
        jinioSigner.setScope();
        jinioSigner.setCanonicalRequest();
        jinioSigner.setStringToSign();
        jinioSigner.setSigningKey();
        jinioSigner.setSignature();
        jinioSigner.setAuthorization();

        return request.newBuilder().header("Authorization", jinioSigner.authorization).build();
    }
    ...
    public static HttpUrl presignV4(Request request, String region, String accessKey, String secretKey, int expires)
        ...
        JinioSigner jinioSigner = new JinioSigner(request, contentSha256, date, region, accessKey, secretKey, null);
        jinioSigner.setScope();
        jinioSigner.setPresignCanonicalRequest(expires);
        jinioSigner.setStringToSign();
        jinioSigner.setSigningKey();
        jinioSigner.setSignature();

        return jinioSigner.url.newBuilder()
                .addEncodedQueryParameter(S3Escaper.encode("X-Amz-Signature"), S3Escaper.encode(jinioSigner.signature))
                .build();
    }
    ...
    public static String postPresignV4(String stringToSign, String secretKey, DateTime date, String region)
            throws NoSuchAlgorithmException, InvalidKeyException {
        JinioSigner jinioSigner = new JinioSigner(null, null, date, region, null, secretKey, null);
        jinioSigner.stringToSign = stringToSign;
        jinioSigner.setSigningKey();
        jinioSigner.setSignature();
